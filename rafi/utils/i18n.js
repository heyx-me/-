...
const resources = {
  en: {
    translation: {
      ...
      "updated": "Updated",
      "syncingYourData": "Syncing your data",
      "syncingDesc": "This may take a moment. We're securely fetching your latest transactions.",
      "noTransactionsTitle": "No transactions detected",
      "noTransactionsAccountDesc": "We couldn't find any transactions across your accounts. If this is unexpected, try refreshing.",
      "today": "Today",
      "yesterday": "Yesterday",
      "thisWeek": "This Week",
      "lastWeek": "Last Week",
  ...
  he: {
    translation: {
      ...
      "signOut": "התנתק",
      "syncing": "מסנכרן...",
      "releaseToSync": "שחרר לסנכרון",
      "pullToSync": "משוך לסנכרון",
      "updated": "עודכן",
      "syncingYourData": "מסנכרן את הנתונים שלך",
      "syncingDesc": "זה עשוי לקחת רגע. אנחנו מושכים את העסקאות האחרונות שלך בצורה מאובטחת.",
      "noTransactionsTitle": "לא נמצאו עסקאות",
      "noTransactionsAccountDesc": "לא הצלחנו למצוא עסקאות בחשבונות שלך. אם זה לא צפוי, נסה לרענן.",
      "today": "היום",
      "yesterday": "אתמול",
      "thisWeek": "השבוע",
      "lastWeek": "שבוע שעבר",
